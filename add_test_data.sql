...
-- 3. 添加成就定義
INSERT OR IGNORE INTO achievements (id, name, description, icon, points, requirement_type, requirement_value, created_at)
VALUES 
  (1, 'First Trade', 'Complete your first trade', '🎯', 100, 'trade_count', 1, datetime('now')),
  (2, 'Active Trader', 'Complete 10 trades', '💹', 300, 'trade_count', 10, datetime('now')),
  (3, 'Trading Master', 'Complete 100 trades', '👑', 1000, 'trade_count', 100, datetime('now')),
  (4, 'Coin Creator', 'Create your first coin', '🚀', 500, 'coins_created', 1, datetime('now')),
  (5, 'Commentator', 'Post 50 comments', '💬', 200, 'comment_count', 50, datetime('now')),
  (6, 'Social Butterfly', 'Get 10 followers', '🦋', 400, 'follower_count', 10, datetime('now')),
  (7, 'Influencer', 'Get 100 followers', '⭐', 1500, 'follower_count', 100, datetime('now')),
  (8, 'Level 10', 'Reach level 10', '🏆', 600, 'level', 10, datetime('now'));
