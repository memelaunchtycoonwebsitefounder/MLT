...
print("🍪 Creating Cookie Consent Modal and CMP Integration...")

# Cookie Consent Modal JavaScript
cookie_modal_js = '''// Cookie Consent Management (GDPR/CCPA Compliance)
...
with open('public/static/cookie-consent.js', 'w', encoding='utf-8') as f:
    f.write(cookie_modal_js)
print("✅ Created public/static/cookie-consent.js")

# Add CSS for cookie banner animation
cookie_css = '''
...
with open('public/static/cookie-styles.css', 'w', encoding='utf-8') as f:
    f.write(cookie_css)
print("✅ Created public/static/cookie-styles.css")

print("\n✅ Cookie Consent Modal created!")
